...
def main():
    ...
    parser = argparse.ArgumentParser(description="ASM v2.6 - Leviathan-Hardened CLI")
    subparsers = parser.add_subparsers(dest="command")
    
    subparsers.add_parser("status", help="Check v2.6 Substrate Pulse")
    ...
    lint_parser = subparsers.add_parser("lint", help="Verify ASM v2.6 standards")
    lint_parser.add_argument("path", default=".", nargs="?")

    sign_parser = subparsers.add_parser("sign", help="Generate v2.6 Soul-Linked Manifest")
