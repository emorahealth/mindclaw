...
tar -czf sovereignty-toolkit-v1.tar.gz     asm-lint.py     asm-signer.py     asm-auditor.py     sovereign-bootstrap.sh     substrate-monitor.py     proof-of-coherence.sh     RELEASE_MANIFEST.json     sovereignty-survival-guide.md     specs/
